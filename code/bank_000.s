...
_usingNonBombBitem:
	cp   $01                                         ; $29da: $fe $01
	jr   z, _throwingJawbone                              ; $29dc: $28 $08

// throwing sword
	ld   hl, $c02a                                   ; $29de: $21 $2a $c0
	ld   a, (hl)                                     ; $29e1: $7e
	cp   $00                                         ; $29e2: $fe $00
	jr   nz, _ret_29d9                             ; $29e4: $20 $f3
...
Call_001_4346:
	...
	ld   (hl), a                                     ; $4360: $77
	ld   hl, wNPC4thBytesOrYCoords                                   ; $4361: $21 $48 $cb
	add  hl, bc                                      ; $4364: $09
	ld   e, (hl)                                     ; $4365: $5e
	ld   d, $00                                      ; $4366: $16 $00
	call Call_001_4380                               ; $4368: $cd $80 $43
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $436b: $21 $3c $cb
	add  hl, bc                                      ; $436e: $09
	ld   a, (hl)                                     ; $436f: $7e
	ld   c, a                                        ; $4370: $4f
	ld   b, $00                                      ; $4371: $06 $00
...
jr_001_4444:
	...
	ld   hl, wNPC4thBytesOrYCoords                                   ; $444b: $21 $48 $cb
	add  hl, bc                                      ; $444e: $09
	ld   a, (hl)                                     ; $444f: $7e
...
Call_001_4655:
	...
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $4663: $21 $3c $cb
	add  hl, bc                                      ; $4666: $09
	ld   a, (hl)                                     ; $4667: $7e
	cp   $00                                         ; $4668: $fe $00
	...
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $468d: $21 $3c $cb
	add  hl, bc                                      ; $4690: $09
	ld   a, (hl)                                     ; $4691: $7e
	ld   c, a                                        ; $4692: $4f
	ld   b, $00                                      ; $4693: $06 $00
...
Call_001_46b4:
	ld   hl, wNPC4thBytesOrYCoords                                   ; $46b4: $21 $48 $cb
	add  hl, bc                                      ; $46b7: $09
	ld   e, (hl)                                     ; $46b8: $5e
	ld   d, $00                                      ; $46b9: $16 $00
...
Call_001_46c4:
	...
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $46d2: $21 $3c $cb
	add  hl, bc                                      ; $46d5: $09
	ld   a, (hl)                                     ; $46d6: $7e
	ld   c, a                                        ; $46d7: $4f
	ld   b, $00                                      ; $46d8: $06 $00
	...
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $4702: $21 $3c $cb
	add  hl, bc                                      ; $4705: $09
	ld   a, (hl)                                     ; $4706: $7e
	add  $01                                         ; $4707: $c6 $01
	ld   c, a                                        ; $4709: $4f
...
Call_001_472a:
	...
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $473e: $21 $3c $cb
	add  hl, bc                                      ; $4741: $09
	ld   a, (hl)                                     ; $4742: $7e
	ld   c, a                                        ; $4743: $4f
	ld   b, $00                                      ; $4744: $06 $00
	...
	dec  de                                          ; $4763: $1b
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $4764: $21 $3c $cb
	add  hl, bc                                      ; $4767: $09
	ld   a, (hl)                                     ; $4768: $7e
	ld   c, a                                        ; $4769: $4f
	ld   b, $00                                      ; $476a: $06 $00
...
Call_001_478a:
	...
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $479e: $21 $3c $cb
	add  hl, bc                                      ; $47a1: $09
	ld   a, (hl)                                     ; $47a2: $7e
	ld   c, a                                        ; $47a3: $4f
	ld   b, $00                                      ; $47a4: $06 $00
	...
	inc  de                                          ; $47c6: $13
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $47c7: $21 $3c $cb
	add  hl, bc                                      ; $47ca: $09
	ld   a, (hl)                                     ; $47cb: $7e
	ld   c, a                                        ; $47cc: $4f
	ld   b, $00                                      ; $47cd: $06 $00
...
func_47ed:
	...
	ld   a, e                                        ; $47fa: $7b
	push af                                          ; $47fb: $f5
	ld   hl, wNPC4thBytesOrYCoords                                   ; $47fc: $21 $48 $cb
	add  hl, bc                                      ; $47ff: $09
	ld   e, (hl)                                     ; $4800: $5e
	ld   d, $00                                      ; $4801: $16 $00
...
func_4849:
	...
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $4853: $21 $3c $cb
	add  hl, bc                                      ; $4856: $09
	ld   a, (hl)                                     ; $4857: $7e
	add  $01                                         ; $4858: $c6 $01
...
Jump_001_651f:
	...
	ld   e, a                                        ; $6524: $5f
	ld   d, $00                                      ; $6525: $16 $00
	ld   hl, wNPC2ndByteLower6Bits                                   ; $6527: $21 $84 $cb
	add  hl, bc                                      ; $652a: $09
	ld   a, (hl)                                     ; $652b: $7e
	and  $f0                                         ; $652c: $e6 $f0
	push hl                                          ; $652e: $e5
...
Call_001_669b:
	ld   hl, wNPC4thBytesOrYCoords                                   ; $669b: $21 $48 $cb
	add  hl, bc                                      ; $669e: $09
	ld   a, (hl)                                     ; $669f: $7e
	srl  a                                           ; $66a0: $cb $3f
	srl  a                                           ; $66a2: $cb $3f
	...
	ld   e, a                                        ; $66a8: $5f
	ld   d, $00                                      ; $66a9: $16 $00
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $66ab: $21 $3c $cb
	add  hl, bc                                      ; $66ae: $09
	ld   a, (hl)                                     ; $66af: $7e
	srl  a                                           ; $66b0: $cb $3f
	srl  a                                           ; $66b2: $cb $3f
...
+
	...
	ld   (hl), a                                     ; $69e7: $77
	ld   hl, wNPC4thBytesOrYCoords                                   ; $69e8: $21 $48 $cb
	add  hl, bc                                      ; $69eb: $09
	ld   a, (hl)                                     ; $69ec: $7e
	adc  $08                                         ; $69ed: $ce $08
	srl  a                                           ; $69ef: $cb $3f
...
func_6c0f:
	...
	and  $40                                         ; $6c14: $e6 $40
	push af                                          ; $6c16: $f5
	ld   hl, wNPC2ndByteLower6Bits                                   ; $6c17: $21 $84 $cb
	add  hl, bc                                      ; $6c1a: $09
	xor  (hl)                                        ; $6c1b: $ae
	ld   (hl), a                                     ; $6c1c: $77
	pop  af                                          ; $6c1d: $f1
...
Jump_001_6dd8:
	...
	ld   (hl), a                                     ; $6e03: $77
	ld   hl, wNPC4thBytesOrYCoords                                   ; $6e04: $21 $48 $cb
	add  hl, bc                                      ; $6e07: $09
	ld   a, (hl)                                     ; $6e08: $7e
...
func_6f99:
	...
	ld   e, a                                        ; $6fa8: $5f
	ld   d, $00                                      ; $6fa9: $16 $00
	ld   hl, wNPC3rdBytesOrXCoords                                   ; $6fab: $21 $3c $cb
	add  hl, bc                                      ; $6fae: $09
	ld   a, (hl)                                     ; $6faf: $7e
	add  $08                                         ; $6fb0: $c6 $08
	srl  a                                           ; $6fb2: $cb $3f
